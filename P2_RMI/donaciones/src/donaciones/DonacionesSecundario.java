 ...
 */
public class DonacionesSecundario extends UnicastRemoteObject implements I_donaciones_servidor,
    ...
    public DonacionesSecundario(String nombre, String replica) throws RemoteException {
    ...
    public float consultarTotal(String cliente) throws RemoteException {
        ...
        if (cantidad_donaciones > 0){
            I_donaciones_replica la_replica = this.getReplica("localhost", this.replica);
            valor_retorno = la_replica.getSubtotal();
        }
